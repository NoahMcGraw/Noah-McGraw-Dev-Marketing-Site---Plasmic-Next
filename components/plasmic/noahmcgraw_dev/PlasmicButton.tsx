...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dVJtEG1Aqjru/css
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kGjaE)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStartIcon, {
              ...
              [sty.slotTargetStartIconcolor_orange]: hasVariant(
                $state,
                "color",
                "orange"
              ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainercolor_orange]: hasVariant(
            $state,
            "color",
            "orange"
          ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__juCcf)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetEndIcon, {
              ...
              [sty.slotTargetEndIconcolor_orange]: hasVariant(
                $state,
                "color",
                "orange"
              ),
